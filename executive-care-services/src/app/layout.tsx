...
export const metadata: Metadata = {
  ...
  keywords: ["home care", "cleaning services", "gourmet meals", "home healthcare", "luxury services", "concierge services"], // Can be a string or an array
  openGraph: {
  ...
  twitter: {
    card: "summary_large_image" as const,  // Ensure this is correctly defined as one of the supported types
    site: "@executivecare",
    title: "Executive Care Services | Premium Home Care and Concierge Services",
